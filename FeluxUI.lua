...
if not isfolder("FeluxHub") then
    makefolder("FeluxHub")
end
if not isfolder("FeluxHub/Config") then
    makefolder("FeluxHub/Config")
end
...
local ConfigFile = "FeluxHub/Config/FeluxHub_" .. gameName .. ".json"
...
function FeluxHub:MakeNotify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "FeluxHub"
    NotifyConfig.Description = NotifyConfig.Description or "Notification"
    NotifyConfig.Content = NotifyConfig.Content or "Content"
    NotifyConfig.Color = NotifyConfig.Color or Color3.fromRGB(0, 150, 255)
...
function FeluxHub:Window(GuiConfig)
    GuiConfig = GuiConfig or {}
    GuiConfig.Title = GuiConfig.Title or "FeluxHub"
    GuiConfig.Footer = GuiConfig.Footer or "FeluxHub"
    GuiConfig.Color = GuiConfig.Color or Color3.fromRGB(0, 150, 255)
    ...
    local FeluxHubUI = Instance.new("ScreenGui")
    local DropShadowHolder = Instance.new("Frame")
    local DropShadow = Instance.new("ImageLabel")
    ...
    FeluxHubUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    FeluxHubUI.Name = "FeluxHub"
    FeluxHubUI.ResetOnSpawn = false
    FeluxHubUI.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = FeluxHubUI
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("FeluxHub") then
            FeluxHubUI:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        DialogGlow.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
        ...
        Yes.BackgroundColor3 = Color3.fromRGB(0, 150, 255)
    ...
    UIStroke14.Color = Color3.fromRGB(0, 150, 255)
    UIStroke14.Thickness = 2.5
    UIStroke14.Transparency = 0.8
    UIStroke14.Parent = DropdownSelect

    DropdownSelectReal.AnchorPoint = Vector2.new(0.5, 0.5)
    DropdownSelectReal.BackgroundColor3 = Color3.fromRGB(0, 75, 128)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            function Items:AddParagraph(ParagraphConfig)
                ...
                if ParagraphConfig.ButtonText then
                    ...
                    ParagraphButton.BackgroundColor3 = GuiConfig.Color
            ...
            function Items:AddPanel(PanelConfig)
                ...
                ButtonMain.BackgroundColor3 = GuiConfig.Color
    ...
    local FeluxHubButton = Instance.new("ScreenGui")
    local Button = Instance.new("ImageButton")
    local Corner = Instance.new("UICorner")
    local Scale = Instance.new("UIScale")

    FeluxHubButton.Name = "FeluxHubButton"
    FeluxHubButton.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    FeluxHubButton.ResetOnSpawn = false
    FeluxHubButton.Parent = game:GetService('CoreGui')

    Button.Name = 'FeluxHub'
    Button.Parent = FeluxHubButton
